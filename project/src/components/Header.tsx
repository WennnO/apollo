...
const Header = () => {
  ...
  return (
    <header className="fixed w-full z-50 bg-black/80 backdrop-blur-sm">
      <nav className="container mx-auto px-12 py-8 md:px-8 md:py-8">
        <div className="relative flex justify-between items-center">
          {/* Logo */}
          <Link to="/" className="absolute -left-8 sm:left-0 md:left-2 lg:left-4 flex items-center pt-4">
            <img 
              src={logo} 
              alt="Apollo Logo" 
              className="h-24 w-144 object-contain" 
            />
          </Link>
